...
CITY_BBOXES: dict[str, list[tuple[str, str]]] = {
    ...
    "weimar":          [("Weimar",          "50.96,11.30,51.00,11.38")],
    "sindelfingen":    [("Sindelfingen",    "48.69,8.98,48.73,9.06")],
    "herten":          [("Herten",          "51.57,7.11,51.62,7.20")],
    ...
    "freising":        [("Freising",        "48.38,11.72,48.42,11.79")],
    "bamberg":         [("Bamberg",         "49.87,10.87,49.92,10.95")],
    "straubing":       [("Straubing",       "48.86,12.55,48.90,12.62")],
    "hof":             [("Hof",             "50.29,11.89,50.33,11.97")],
    "kempten":         [("Kempten",         "47.70,10.28,47.74,10.36")],
    "weiden":          [("Weiden i.d.OPf.", "49.65,12.13,49.70,12.21")],
    "kaufbeuren":      [("Kaufbeuren",      "47.86,10.60,47.90,10.68")],
    "amberg":          [("Amberg",          "49.42,11.84,49.47,11.92")],
    "schwabach":       [("Schwabach",       "49.31,11.00,49.35,11.08")],
    "coburg":          [("Coburg",          "50.24,10.94,50.28,11.02")],
