...
CITY_BBOXES: dict[str, list[tuple[str, str]]] = {
    ...
    "norderstedt":     [("Norderstedt",     "53.66,9.93,53.76,10.07")],
    ...
    "arnsberg":        [("Arnsberg",        "51.35,7.95,51.45,8.20")],
    ...
    "kerpen":          [("Kerpen",          "50.82,6.60,50.92,6.82")],
    ...
    "hof":             [("Hof",             "50.24,11.84,50.38,12.04")],
    ...
    "münster":             [("Münster",             "51.87,7.47,52.06,7.78")],
    ...
    "pulheim":             [("Pulheim",             "50.97,6.73,51.07,6.90")],
